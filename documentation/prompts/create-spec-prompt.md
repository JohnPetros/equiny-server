...
refatoração, atuando como um Tech Lead Sênior. O documento deve servir como uma
ponte estritamente definida entre o PRD (Product Requirements Document) e o
código, com nível de detalhe suficiente para que a implementação seja direta e
sem ambiguidades.
...
1. **Pesquisa e Contextualização (Chain of Thought):**
   - **Mapeie o Fluxo:** Antes de escrever, leia o PRD associado a spec que está
...
3. **Estruturação do Documento:** Gere o arquivo Markdown da Spec seguindo
   ...
   - **Dados de request:** Liste os valores que devem ser recebidos pelo
     controller.
   - **Dados de response:** Liste os valores que devem ser retornados pelo
     controller.
   ...
   - **Dados de response:** Liste os valores que devem ser retornados pela
     action.
   - **Métodos:** Assinatura e responsabilidade.
